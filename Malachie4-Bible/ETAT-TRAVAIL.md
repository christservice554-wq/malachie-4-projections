...
- Chaque découverte → résumé + poussée GitHub + lien. Travail par BLOCS archivés
  (si forfait fini/déconnexion : tout est déjà en réserve ici).
- Formats prêts-à-intégrer pour l'autre IA (CSV/JSON : theme;code;§;texte).
...
- NÉHÉMIE : 1 mention → pas de récit (prudent) ; MALACHIE : 370 mentions = citations Mal 4.
- Fichiers : Histoires/Histoires-2-*.md + 4 extrait-*.txt

## BLOC 3 — Passage/Contexte Apo 10:7 + Jean 3:16 : FAIT ✔ poussé
- Apo 10:7 : 149 P (74 prédications) + 835 C ; Jean 3:16 : 116 P (95 préd.) + 3 525 C.
